              ...
              <div className="row">
                ...
                <form className="info">
                  <div className="dropdown">
                    <label htmlFor="text">Pentunjuk Transfer mBangking</label>
                    <span>
                  ...
                  <div className="dropdown">
                    <label htmlFor="text">Pentujuk Transfer iBangking</label>
                    <span>
                      <i className="fa-solid fa-caret-down"></i>
                    </span>
                  ...
                  <div className="dropdown">
                    <label htmlFor="text">Pentujuk Transfer ATM </label>
                    <span>
                      <i className="fa-solid fa-caret-down"></i>
                    </span>
        ...
        <div className="container mb-3">
          <div className="row align-items-center">
            ...
            <div className="col-md-6 order-md-2 order-1">
              ...
              <form className="info">
                <div className="dropdown">
                  <label htmlhtmlFor="text">Donasimu mendanai 5 hal ini :</label>
                  <span>
                    <i className="fa-solid fa-caret-down"></i>
                  </span>
                  <div className="dropdown-content">
              ...
              <form className="info">
                <div className="dropdown">
                  <label htmlhtmlFor="text">Krisis iklim dan kehidupan kita :</label>
                  <span>
                    <i className="fa-solid fa-caret-down"></i>
                  </span>
                  <div className="dropdown-content">
              ...
              <form className="info">
                <div className="dropdown">
                  <label htmlhtmlFor="text">Solusi krisis iklim :</label>
                  <span>
                    <i className="fa-solid fa-caret-down"></i>
                  </span>
                  <div className="dropdown-content">
